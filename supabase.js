...
const SheetsAPI = {
  ...
  actualizarEmailUsuario: actualizarEmailUsuario, // Actualizar correo del usuario
...
/**
 * Actualiza el correo de un usuario en Supabase
 * @param {string} chapa - Chapa del usuario
 * @param {string} email - Nuevo correo a guardar
 * @returns {Promise<{success: boolean, message: string}>}
 */
async function actualizarEmailUsuario(chapa, email) {
  try {
    console.log('Actualizando correo para chapa ' + chapa + ': ' + email);
    ...
    if (error) {
      console.error('Error al actualizar correo en Supabase:', error);
      return { success: false, message: error.message };
    }

    console.log('Correo actualizado correctamente:', data);
